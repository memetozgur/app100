...
import 'myorders_section_model.dart';
export 'myorders_section_model.dart';

class MyordersSectionWidget extends StatefulWidget {
  const MyordersSectionWidget({
    super.key,
    this.userprameters,
    this.courseprameters,
  });

  final DocumentReference? userprameters;
  final DocumentReference? courseprameters;

  @override
  State<MyordersSectionWidget> createState() => _MyordersSectionWidgetState();
}

class _MyordersSectionWidgetState extends State<MyordersSectionWidget>
    with TickerProviderStateMixin {
  late MyordersSectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyordersSectionModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<CoursesRecord>(
                                                              ...
                                                              Padding(
                                                                padding: EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                                child: Text(
                                                                  '${functions.addOne(listViewIndex).toString()} / ${listViewSectionRecord.sectionName}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
