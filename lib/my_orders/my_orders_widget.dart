...
class MyOrdersWidget extends StatefulWidget {
  const MyOrdersWidget({
    super.key,
    this.sectionprameters,
  });

  final DocumentReference? sectionprameters;
                        ...
                        child: Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Builder(
                              builder: (context) {
                                final myorders =
                                    (currentUserDocument?.myorders.toList() ??
                                            [])
                                        .map((e) => e)
                                        .toList();
                                if (myorders.isEmpty) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, myordersIndex) {
                                    final myordersItem =
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('query_orders_code');
                                    },
                                    child: Container(
